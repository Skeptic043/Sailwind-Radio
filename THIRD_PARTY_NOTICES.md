...
Sailwind, Unity, BepInEx, Harmony and music supplied by the player retain their own rights and terms. Game and loader assemblies are external build references and are not included in the source or test packages.
